...
(Windows and macOS; on Linux you run the daemon yourself for now — see `docs/PLATFORM.md`).
...
**Windows and Linux (incl. WSL2) v0.4.0.** macOS is at a very early stage: the Keychain
